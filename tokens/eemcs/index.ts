...
const TOKEN_NAME = "EEMCS Token";
const TOKEN_SYMBOL = "EEMCS";
const TOKEN_DESCRIPTION = "A token for life";
const TOKEN_IMAGE_NAME = "eemcs-token.png"; // Replace unicorn.png with your image name
const TOKEN_IMAGE_PATH = `tokens/eemcs/assets/${TOKEN_IMAGE_NAME}`;

async function createEEMCSToken(
...
async function main() {
  ...
  await createEEMCSToken(connection, payer);
}
